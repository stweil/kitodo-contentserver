...
/************************************************************************************
 * all file formats as central enumeration with some central getter methods for
 * the requested {@link ImageInterpreter}, {@link ImageFileFormat} or Mimetype
 * 
 * @version 02.01.2009 
...
public enum ImageFileFormat {
	...
	/************************************************************************************
	 * get {@link ImageInterpreter} for {@link URL} as parameter using proxy
	 * informations
	 * 
	 ...
	 * @throws IOException
	 ************************************************************************************/
	public static ImageInterpreter getInterpreter(URL url,
			String httpproxyhost, String httpproxyport, String httpproxyuser,
			String httpproxypasswd) throws ImageInterpreterException,
			IOException {
		
		String mimetype = StreamUtils.getMimeTypeFromUrl(url, httpproxyhost,
				httpproxyport, httpproxyuser, httpproxypasswd);
	...
	/************************************************************************************
	 * get {@link ImageInterpreter} for file format by using
	 * {@link FileInputStream} as parameter
	 * 
	 * @return requested ImageInterpreter for file format
	 ...
	 * @throws ImageInterpreterException
	 ************************************************************************************/
	public ImageInterpreter getInterpreter(InputStream inputFileStream)
			throws ImageInterpreterException {
		switch (this) {
		case TIFF:
	...
	/************************************************************************************
	 * get {@link ImageInterpreter} for file format by using
	 * {@link RenderedImage} as parameter
	 * 
	 * @param image
	 *            the image as RenderedImage
	 * @return requested ImageInterpreter for file format
	 ************************************************************************************/
	...
	/************************************************************************************
	 * get {@link ImageFileFormat} for file format by using the file extension
	 * as {@link String} parameter
	 * 
	 * @param extension
	 *            the file extension ob the file to use
	 * @return requested ImageFileFormat
	 ************************************************************************************/
	public static ImageFileFormat getImageFileFormatFromFileExtension(
			String urlstring) {
		if (urlstring == null) {
			return null;
		}
		...
		String ext = extensions[(extensions.length)-1].toLowerCase().trim();
