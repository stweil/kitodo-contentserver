 ...
 ************************************************************************************/
public class PngInterpreter extends AbstractImageInterpreter implements
		ImageInterpreter {
	private static final Logger logger = Logger.getLogger(PngInterpreter.class);

	/************************************************************************************
	 * Constructor for {@link PngInterpreter} to read an png image from given
	 * {@link InputStream}
	 * 
	 * @param inStream
	 *            {@link InputStream}
	 ...
	 ************************************************************************************/
	public PngInterpreter(InputStream inStream)
			throws ImageInterpreterException {
		...
		if (it.hasNext()) {
			...
			throw new ImageInterpreterException(
					"Imagereader for PNG format couldn't be found!");
		}
		...
		try {
			...
			throw new ImageInterpreterException(
					"Something went wrong while reading the PNG from input stream",
					e);
		}
	...
	public void writeToStream(OutputStream outStream) {
		...
		try {
			...
			ImageWriter writer = (ImageWriter) writerIter.next(); // get writer from ImageIO
	...
	/**
	 * helper methods to parse the DOM tree getting a element and an attribute
	 * node
	 */
